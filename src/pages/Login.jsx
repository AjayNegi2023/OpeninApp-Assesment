  ...
  if (authenticated && !check) {
    ...
    return (
      <div className={`flex flex-col sm:flex-row justify-between items-center w-full ${theme === "dark" ? "bg-[#000000]" : "bg-[#F5F5F5]"}`}>
        <div className={`relative h-[976px] top-[24px] left-[32px] w-[704px] ${theme === "dark" ? "bg-gradient-to-tr from-[#2EBF91] to-[#8360C3]" : "bg-gradient-to-tr from-[#8360C3] to-[#2EBF91]"} p-[32px] hidden sm:block`}>
          ...
          <div className="flex flex-col justify-center gap-4 items-center">
            ...
            <div className={`flex rounded-2xl flex-col items-center mx-auto ${theme === "dark" ? "bg-[#0D0D0D]" : "bg-white"}`}>
              <form className="flex flex-col px-10 py-6 gap-4">
                ...
                <p className={`text-[#346BD4] cursor-pointer ${theme === "dark" ? "text-white" : "text-black"}`}>
                  Forgot password?
                </p>
                <button
                  onClick={handleClick}
                  className={`rounded-xl w-[280px] sm:w-[325px] h-[40px] font-bold text-white ${theme === "dark" ? "bg-[#605BFF]" : "bg-[#605BFF]"}`}
                >
                  Sign In
                </button>
              </form>
            ...
            <p className={`mx-auto ${theme === "dark" ? "text-white" : "text-[#858585]"}`}>
              ...
              <span
                ...
                className={`cursor-pointer ${theme === "dark" ? "text-[#346BD4]" : "text-[#346BD4]"}`}
              >
                Register here
              </span>
            </p>
